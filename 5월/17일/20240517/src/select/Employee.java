...
public class Employee {
	...
	public String toString() {
		return "[EMP_ID=" + EMP_ID + ", EMP_NAME=" + EMP_NAME + ", EMP_NO=" + EMP_NO + ", EMAIL=" + EMAIL + ", PHONE="
				+ PHONE + ", DEPT_CODE=" + DEPT_CODE + ", JOB_CODE=" + JOB_CODE + ", SAL_LEVEL=" + SAL_LEVEL
				+ ", SALARY=" + SALARY + ", BONUS=" + BONUS + ", MANAGER_ID=" + MANAGER_ID + ", HIRE_DATE=" + HIRE_DATE
				+ ", ENT_DATE=" + ENT_DATE + ", ENT_YN=" + ENT_YN + "]";
	}
}
