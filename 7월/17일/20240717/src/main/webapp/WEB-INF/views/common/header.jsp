...
<!-- 내가 가지고 있는 파일 포함하기 -->
<link rel="stylesheet" href="${path}/resources/css/style/style.css"
	type="text/css">
	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<a class="navbar-brand" href="${path}/member/index.do"> 
				<img src="${path}/resources/img/logo-spring.png"alt="스프링로고" width="80px" />
			</a>
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="${path}/member/index.do"> 회원가입 </a> 
